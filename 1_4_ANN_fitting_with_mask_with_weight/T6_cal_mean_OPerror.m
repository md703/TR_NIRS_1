...
num_anser_to_generate=10; % number of target stest_fitting_2024-01-21-12-09-54_new_cw_ANNpec (true answer)
...
fitting_dir='fitting_tr1234_gate123456';
...
%                 OP_error_arr(:,:,OP_error_counter)=abs(temp_fitted_OP./OP_answer_arr(:,:,target_i)-1);
                OP_error_arr(:,:,OP_error_counter)=temp_fitted_OP./OP_answer-1;
