...
%% param
folderPath='20240507/phantom_3/IRF';
...
fileNames={};
for num=1:5
    fileNames{num}=[save_name '_450_' num2str(num) '.phu'];
end
...
save(fullfile(folderPath,[save_name '_TPSF_collect.mat']),'TPSF_collect');
save(fullfile(folderPath,[save_name '_info_record.mat']),'info_record');
