...
for sim=1:size(mu_table,1)
   ...
   if sim==1
       ...
       for s=1:5
           nexttile;
           semilogy(1:1:10,dtof_true(1+(s-1)*10:10*s),'Linewidth',1.5);
           hold on
           semilogy(1:1:10,dtof_ANN(1+(s-1)*10:10*s),'Linewidth',1.5);
           hold on
           xlabel('time gate')
           ylabel('reflectance')
           ...
           yyaxis right
           ax = gca;
           plot(1:1:10,100*RMSPE(1+(s-1)*10:10*s),'-o','Linewidth',2,'Color',[0 0.6 0]);
           hold on
