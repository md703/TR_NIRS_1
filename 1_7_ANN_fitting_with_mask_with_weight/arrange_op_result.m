...
input_dir='test_fitting_2024-01-11-12-32-07'; % please move the fitting folders into this folder first.
subject_name_arr={'KB'};
...
fitting_dir={'fitting_cw123456_tr234'}; % the fitting folder
