%{
Fitting the generated target spectrum and DTOF
...
input_dir='test_fitting_2024-06-16-00-59-47'; % the folder containing the generated target spectrum
...
if tr_flag
    ...
    % choose gate or not
    choose_gate_flag=0; % =0: fitted the gate within 50%~0.01% max value
    gate_choosed=[1 2]; % if choose_gate_flag==1
    num_gate=10;
