...
for sbj_i=1:length(subject_name_arr)
    ...
    load(fullfile(output_dir,'for_S2.mat'));
...
print(fullfile('results_smooth',subject_name,'smooth_result.png'),'-dpng','-r200');
...
print(fullfile('results_smooth',subject_name,'smooth_effect.png'),'-dpng','-r200');