...
layer_mus=[160,125,23,150,450]; % mus for each layer, 1/cm
n=1.4;
g=0.9;
...
%     end
% end
mus_table=repmat(layer_mus,10,1);
...
sim_set.detector_NA=ones(sim_set.num_SDS,1)*0.22;
