...
%                             to_plot_true_sk=dtof_arrange_sk(:,9+(now_SDS-1)*num_gate:8+now_SDS*num_gate);
    ...
    %                     set(fig2,'visible','off');
                    ...
                    for g=1:num_gate
                        ...
                        hold on
                        plot(mus_lb(mus):25:mus_ub(mus),to_plot_smooth_1(:,g),'-o','Linewidth',linewidth);
                        hold on
...
%                             smooth_error_sk_2=sqrt(mean((to_plot_smooth_2(2:size(to_plot_orig,1)-1,:)./to_plot_true_sk(2:size(to_plot_orig,1)-1,:)-1).^2,1));
                        ...
                        figure(1);
                        nexttile;
                        plot(1:1:num_gate,100*orig_error,'.','MarkerSize',markersize);
                        hold on
                        if mus==2
...
% %                             hold on
                        elseif mus==4
                            plot(1:1:num_gate,100*smooth_error_gm,'.','MarkerSize',markersize);
                            hold on
                            plot(1:1:num_gate,100*smooth_error_gm_1,'.','MarkerSize',markersize);
                            hold on
                            plot(1:1:num_gate,100*smooth_error_gm_2,'.','MarkerSize',markersize);
                            hold on
