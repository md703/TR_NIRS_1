...
%% param
input_dir='20201206_test_13'; % the folder of the experiment
...
target_index=[1:7]; % the index to plot
output_name='p1_errorShift_1_7'; % the saved picture name
% output_name='takeUp_tc'; % the saved picture name
reset_legend_name=1; % =1 to rename the index to [1 2 ......]
reset_subject_name='p1';
