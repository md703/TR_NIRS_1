%{
Evaluate the stability and preprocess the data
...
for p=1:num_phantom
    ...
    for s=1:num_SDS
        ...
        target_mean{p}(:,s)=mean(TPSF_binning{p,s},2);
        target_cv(:,s)=std(TPSF_binning{p,s},[],2)./target_mean{p}(:,s);
...
save(fullfile(input_dir,'TPSF_processed.mat'),'bg_mean','IRF_mean','target_mean');
